  ...
  public class TabMenu_UGUI : MonoBehaviour
  {
    ...
    public void SelectTab(int tabIndex)
    {
      ...
      if (tabIndex >= 0 && tabIndex < tabsCount)
      {
        ...
        // We delay by 2 frames so we can override anything that was set
        // for navigation during those 2 frames.
        this.InvokeDelayedByFrames(UpdateFirstContentSelectableNavigation, 2);
      }
    }
